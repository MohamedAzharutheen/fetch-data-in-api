...
<li>{post.email}</li>
          ...
          {post.map((post) => {
            return (
              ...
              >
                ...
                <li className="p-2">Name:{post.name}</li>
                <li className="p-2">Mail:{post.email}</li>
                <li className="p-2">Comment:{post.body}</li>
              </div>
            );
          })}
        </ul></>
        ...
        <div className="text-center my-96">
          <button
            disabled
            type="button"
            className="text-white m-10 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center"
          >
            <svg
              aria-hidden="true"
              role="status"
